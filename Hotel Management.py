class hotelmanage:
    ...
    def roomrent(self):#sel1353
        ...
        print ("1.  Platinum---->4000")

        print ("2.  Diamond---->3000")
        ...
        if(x==1):
            ...
            print ("you have choose room Platinum")

            self.s=4000*n

        elif (x==2):

            print ("you have choose room Diamond")

            self.s=3000*n

        elif (x==3):

            print ("you have choose room Gold")

            self.s=2000*n

        elif (x==4):
            print ("you have choose room Silver")
